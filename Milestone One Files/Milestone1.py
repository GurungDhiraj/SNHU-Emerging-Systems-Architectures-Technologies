...
while repeat:
    try:
        ...
        # Forloop to incremeent duty cycle by 5, in the range 0-100
        for dutyCycle in range(0, 100, 5):
            # increment by dutyCycle 5
            dutyCycle = dutyCycle + 5
            
            #print(dutyCycle)

            # implement dutyCycle change
            pwm18.ChangeDutyCycle(dutyCycle)

            # Adds a 1/10th pause between updates
            time.sleep(.1)
        ...
        print('Keyboard Interrupted: Stopping PWM and Cleaning Up')
        pwm18.stop()
        GPIO.cleanup()
        repeat = False
