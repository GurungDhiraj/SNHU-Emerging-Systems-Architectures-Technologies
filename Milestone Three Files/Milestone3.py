...
class CWMachine(StateMachine):
    ...
    ##
    ## toggleMessage - method used to switch between message1 = SOS
    ## and message2 = OK
    ##
    def toggleMessage(self):
        ...
        # If message is SOS change to OK, and vice versa
    ...
    def transmit(self):
        ...
        while not self.endTransmission:
            ...
            for word in wordList:
                ...
                # note the difference between word vs words
...
# code to process the input of button when pressed
